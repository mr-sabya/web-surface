    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            <ul class="nav nav-secondary">
                ...
                <li class="nav-item {{ Route::is('admin.website.*') || Route::is('admin.service.*') || Route::is('admin.technology.*') || Route::is('admin.portfolio.*') ? 'active submenu' : '' }}">
                    <a data-bs-toggle="collapse" href="#webiste">
                        <i class="fas fa-desktop"></i>
                        <p>Website</p>
                        <span class="caret"></span>
                    </a>
                    <div class="collapse {{ Route::is('admin.website.*') || Route::is('admin.service.*') || Route::is('admin.technology.*') || Route::is('admin.portfolio.*') ? 'show' : '' }}" id="webiste">
                        <ul class="nav nav-collapse">
